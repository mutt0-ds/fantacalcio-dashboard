...
class Player:
    ...
    news: str = ""  # totale menzioni da sosfanta
    titolare: str = ""  # status titolare
    dati: str = ""  # partite, gol e assist
    ...
    def scraper_status_titolare(self, liste_status: list):
        ...
        (
            titolari,
            tabella_ballottaggi,
            tabella_squalificati,
            tabella_indisponibili,
            lista_scontri,
        ) = liste_status
...
def estrazione_formazioni(PROBABILI_FORMAZIONI: str) -> list:
    """
    estrae 5 liste di dati riguardanti titolari, ballottaggi, squalifiche e infortuni e gli scontri in programma
    """
